...
The driver-facing Expo and React Native app. It runs Metro on port 8082 and calls the shared server through tRPC.

## Key files

- `app/` contains Expo Router routes. Folder names in parentheses group routes without adding a URL segment.
- `components/` contains driver-only UI components.
- `contexts/` contains driver context providers.
